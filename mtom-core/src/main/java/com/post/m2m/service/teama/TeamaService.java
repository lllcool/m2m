...
return teama;
    ...
    */
    public PageVO
    <TeamaListVO> list(TeamaQO teamaQO) {
        PageVO
        <TeamaListVO> page = teamaDAO.findByPage(teamaQO);
            return page;
            }
                        ...
                        */
                        ...
                        List
                        <OptionVO<String, String>> options = teamaDAO.findOptions(qo);
                        return options;
                        }
                    ...
                    * @return
                    */
                    public TeamaPO getTeama(String id, boolean
                    force) {
