...
<InvoiceDetailAddDTO> list) {
    ...
    */
    public PageVO
    <InvoiceDetailListVO> list(InvoiceDetailQO invoiceDetailQO) {
        PageVO
        <InvoiceDetailListVO> page = invoiceDetailDAO.findByPage(invoiceDetailQO);
            return page;
            }
                    ...
                    * @return
                    */
                    public InvoiceDetailPO getInvoiceDetail(String id, boolean
                    force) {
