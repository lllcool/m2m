                    package com.post.m2m.service.sturefteach;
...
<StuRefTeachAddDTO> list) {
    ...
    */
    public PageVO
    <StuRefTeachListVO> list(StuRefTeachQO stuRefTeachQO) {
        PageVO
        <StuRefTeachListVO> page = stuRefTeachDAO.findByPage(stuRefTeachQO);
            return page;
            }
                    ...
                    * @return
                    */
                    public StuRefTeachPO getStuRefTeach(String id, boolean
                    force) {
