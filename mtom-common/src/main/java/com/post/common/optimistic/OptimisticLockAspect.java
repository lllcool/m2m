...
import com.post.common.pojo.po.Version;
...
public class OptimisticLockAspect {
     ...
     * 用于抛出乐观锁冲突时的异常
     */
    @Pointcut("execution(int com.post.common.dao.DAO.update(com.post.common.pojo.po.AbstractPO))")
     ...
     * 捕获乐观锁冲突异常，并重试
     */
    @Pointcut("execution(@com.post.common.optimistic.OptimisticLock * *(..))")
